...
//!
//! Provides a function to convert HTTP status codes to their canonical text representation.

/// Returns the canonical text representation of an HTTP status code.
///
/// # Examples
///
/// ```
/// use http_visualizer_app::shared::status_text;
///
